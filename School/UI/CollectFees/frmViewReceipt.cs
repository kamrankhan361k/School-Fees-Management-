...
namespace School.UI.CollectFees
{
    public partial class frmViewReceipt : Form
    {
        ...
        {
            Result<DataTable> _Result = _ReceiptService.GetAllFeesReceipt(Convert.ToString(Properties.Settings.Default.Year));
            ...
            if (_FeesDataTable != null)
            {
                if (!string.IsNullOrEmpty(txtSearch.Text.Trim()))
                {
                    ...
                    EnumerableRowCollection<DataRow> _Query = from fees in _FeesDataTable.AsEnumerable()
                                                              where fees.Field<string>("Name").ToLower().Contains(_Search) || fees.Field<string>("Standard").ToLower().Contains(_Search) || fees.Field<string>("Division").ToLower().Contains(_Search) || fees.Field<string>("Department").ToLower().Contains(_Search) || fees.Field<string>("FeesType").ToLower().Contains(_Search)
                                                              select fees;
